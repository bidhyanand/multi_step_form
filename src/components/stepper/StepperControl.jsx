...
const StepperControl = ({ handleClick, currentStep, steps }) => {
    return (
        <div className="container flex justify-around mb-8">
            ...
            <button
                onClick={() => handleClick()}
                className={`bg-gray-400 text-black uppercase py-2 px-4 rounded-xl font-semibold cursor-pinter boder-2 border-slate-500  hover:bg-slate-700 hover:text-white transition  duration-200 ease-in-out ${currentStep === 1 ? "opacity-50 cursor-not-allowed" : ""
                    } `}
            >
                Back
            </button>
